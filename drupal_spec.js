    ...
    describe("can create account & login", function() {
        ...
        it("calls system.connect", function() {
            ...
            runs(function() {
                ...
                drupal.systemConnect(function(responseData) {
        ...
        it("can log in", function() {
            ...
            runs(function() {
                drupal.login(user.name, user.pass, function() {
